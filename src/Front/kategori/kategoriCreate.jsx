    ...
    <div className="flex">
      ...
      <div className={`flex-1 w-full ${isSidebarOpen ? 'ml-0' : 'ml-0'}`}>
                  ...
                  <ul className="inline-flex items-center space-x-1 md:space-x-3">
                      ...
                      <li className="lg:block hidden">
                        <div className="flex items-center">
                          ...
                          <span className="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Create Kategori</span>
                        </div>
                      </li>
                  </ul>
              </div>
        ...
        <div className="mt-4 mx-8">
          <form onSubmit={storeKategori} className="p-4 bg-white rounded-md shadow dark:border-gray-700 dark:shadow-gray-900">
            <div className="space-y-6">
              <div className="mb-4">
                <label htmlFor="kategori" className="block mb-2 text-sm font-medium">
                  Kategori
                </label>
                <input type="text" onChange={(e) => setKategori(e.target.value)} className="border border-gray-300 text-gray-900 text-sm rounded-md block w-full p-2" />
                {
                  errors.kategori && (
                    <div className="p-4 mb-4 my-2 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                        <span className="font-medium">{errors.kategori[0]}</span>
                    </div>
                  )
                }
              </div>
